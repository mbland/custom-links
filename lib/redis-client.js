...
function addUrlToOwner(t_, owner, url) {
  return new Promise(function(resolve, reject) {
...
function removeUrlFromOwner(t_, owner, url) {
  return new Promise(function(resolve, reject) {
...
RedisClient.prototype.create = function(url, location, owner) {
  ...
  return new Promise(
    ...
    .then(function() {
      return addUrlToOwner(t_, owner, url).catch(function(err) {
        throw new Error('redirection created for ' + url +
...
RedisClient.prototype.changeOwner = function(url, newOwner) {
  ...
  return updateProperty(this, url, 'owner', newOwner)
    .then(function(oldOwner) {
      ...
      return Promise.all([
        addUrlToOwner(t_, newOwner, url).catch(function(err) {
          throw new Error(errPrefix + 'add it to new owner\'s list: ' + err)
        }),
        removeUrlFromOwner(t_, oldOwner, url).catch(function(err) {
...
RedisClient.prototype.deleteRedirection = function(url) {
  ...
  return t_.get(url)
    .then(function(urlData) {
      ...
      .then(function() {
        return removeUrlFromOwner(t_, urlData.owner, url).catch(function(err) {
