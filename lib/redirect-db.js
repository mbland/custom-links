...
RedirectDb.prototype.getLink = function(link, options) {
  options = options || {}
...
RedirectDb.prototype.createLink = function(link, location, user) {
  return this.userExists(user)
    .then(() => {
      return this.client.createLink(link, location, user)
...
RedirectDb.prototype.getOwnedLinks = function(user) {
  return this.userExists(user)
...
RedirectDb.prototype.checkOwnership = function(link, user) {
...
RedirectDb.prototype.updateProperty = function(link, user, property, value) {
...
RedirectDb.prototype.changeOwner = function(link, user, newOwner) {
  return Promise.all(
    [
...
RedirectDb.prototype.updateLocation = function(link, user, newLocation) {
  return this.updateProperty(link, user, 'location', newLocation)
}

RedirectDb.prototype.deleteLink = function(link, user) {
  return this.checkOwnership(link, user)
    .then(() => {
